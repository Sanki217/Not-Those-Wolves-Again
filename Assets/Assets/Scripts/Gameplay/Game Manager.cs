...
public class GameManager : MonoBehaviour
{
    ...
    public AudioSource dogDeathSound;       // Zmienna dla düwiÍku úmierci psa
    public AudioSource sheepSafeSound;      // èrÛd≥o düwiÍku dla owcy w bezpiecznej strefie
    public AudioSource sheepDyingSound;     // èrÛd≥o düwiÍku dla úmierci owcy
    ...
    public void SheepInSafeZone(int sheepIndex)
    {
        ...
        // OdtwÛrz düwiÍk dla kaødej owcy wchodzπcej do zagrody
    ...
    public void SheepDied(int sheepIndex)
    {
        ...
        // OdtwÛrz düwiÍk úmierci owcy
        if (sheepDyingSound != null)
        {
            sheepDyingSound.Play();
        }
    ...
    public void GameOver()
    {
        ...
        {
            dogDeathSound.Play();  // OdtwÛrz düwiÍk úmierci psa
        }
